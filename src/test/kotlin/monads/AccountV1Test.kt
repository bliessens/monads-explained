...
internal class AccountV1Test {
    ...
    internal fun testNegativeBalanceExplicitTyping() {
        try {
            val result: AccountV1 = AccountV1.create(100.toBigDecimal().negate())
    ...
    internal fun testDepositBadCase() {
        ...
        val updated: AccountV1 = if (account is AccountV1)
            AccountV1.create(account.balance + 100.toBigDecimal())
        else account
